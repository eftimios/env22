...
class RewardCalculator:
    ...
    Draw-awareness penalty: penalize missed opportunities using would_complete_set/run.
    """
    ...
    def calculate_step_reward(
        ...
        """
        Per-step reward. Tracks invalid actions and draw-phase missed opportunities.
        """
        if is_invalid:
